...
import { getUserByEmail, crateUser as createUser } from "../db/userModel";
    ...
    try {
        ...
        if(user!.authentication!.password != expectedHash)
        {
          return res.status(StatusCodes.BadRequest).json({
            message: labels.users.password.incorrect_password,
        ...
        await user!.save()
        res.cookie(Appconfig.TOKEN_KEY,user!.authentication!.sessionToken!, {domain : 'localhost', path: '/'})
